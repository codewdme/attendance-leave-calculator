...
const App = () => {
  ...
  function handleSubmit(e){
    ...
    newTotalAttendance = Math.floor((totalClassesAttended/totalClasses)*100);
    
    setTotalAttendance(newTotalAttendance);
    let newTotalAvailableLeaves = Math.floor(((totalClassesAttended-(0.75*totalClasses))/0.75));
    let newTotalClassesToAttend = Math.floor(((0.75*totalClasses)-totalClassesAttended)/0.25);
  ...
  return (
    ...
    <div className='flex justify-center align-center gap-10 bg-white rounded-xl p-8 w-[333px]'>
      

      <Calculate toggle={toggle} show={show} handleChange={handleChange} handleChange2={handleChange2} handleSubmit={handleSubmit} />
      <Result toggle={toggle} show={show} totalAttendance={totalAttendance} totalAvailableLeaves={totalAvailableLeaves} totalClassesToAttend={totalClassesToAttend}/>
